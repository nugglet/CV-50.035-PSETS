...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # Loss
        loss1, out_1 = softmax_loss(scores, y)
        loss2 = 0.5 * self.reg * (np.sum(np.square(self.params['W1'])) + np.sum(np.square(self.params['W2'])))
        loss = loss1 + loss2

        # gradients
        k1, grads['W2'], grads['b2'] = affine_backward(out_1, cache3)
        k2 = relu_backward(k1, cache2)
        _, grads['W1'], grads['b1'] = affine_backward(k2, cache1)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in range(1, self.num_layers + 1):
            scores, cache['affine'+ str(i)] = affine_forward(scores, self.params['W' + str(i)], self.params['b' + str(i)])
        ...
        for i in range(self.num_layers, 0, -1):
            ...
            last_grad, grads['W' + str(i)], grads['b' + str(i)] = affine_backward(last_grad, cache['affine' + str(i)])
